...
struct leveldb_filterpolicy_t : public FilterPolicy {
  ...
  bool KeyMayMatch(const Slice& key, const Slice& filter) const override {
    return (bool) ((*key_match_)(state_, key.data(), key.size(), filter.data(),
                         filter.size()));
  }
